...
溯源跟踪、工具合约和执行门控的结构化接口层，覆盖五种生物信息学分析类型。 (v1.4.0, 2026-06-21 — 723 测试通过, 0 ruff/mypy 错误, 5/5 插件真实执行验证通过)
...
.. list-table::
   ...
   * - ``metagenomic_plasmid``
     - 67
       ...
       DAG 驱动规划 (UniversalDAG)，并行执行，8 张 sciplot 图
       (barplot×3, scatterplot, stacked_barplot, heatmap×5)。
       10 个 conda 环境，84 节点 DAG (3054 行)，10 个数据库。
...
- `开发计划 (英文) </en/next_development_plan.html>`_ — 下一步开发计划 + Phase 1-3 工程修复
