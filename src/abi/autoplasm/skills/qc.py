"""Backward-compatibility shim — proxies to abi.plugins.metagenomic_plasmid._engine.skills.qc."""
...
_target = _sys.modules["abi.plugins.metagenomic_plasmid._engine.skills.qc"]
