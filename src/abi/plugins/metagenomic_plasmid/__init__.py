...
class MetagenomicPlasmidPlugin:
    ...
    def internal_handlers(self):
        """Return internal DAG handlers for passthrough nodes."""
        return _metagenomic_plasmid_handlers()
...
def _plan_from_dict(data: Mapping[str, Any]) -> ExecutionPlan:
    ...
    return ExecutionPlan(
        ...
        plasmid_strategy=str(data.get("plasmid_strategy", "single_tool")),
    )
